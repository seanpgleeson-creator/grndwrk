...
CREATE TABLE "EarningsSignal" (
    ...
    CONSTRAINT "EarningsSignal_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "CompanyPositioningBrief" (
    ...
    CONSTRAINT "CompanyPositioningBrief_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "RolePositioningBrief" (
    ...
    CONSTRAINT "RolePositioningBrief_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "EarningsSignal" ADD CONSTRAINT "EarningsSignal_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CompanyPositioningBrief" ADD CONSTRAINT "CompanyPositioningBrief_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RolePositioningBrief" ADD CONSTRAINT "RolePositioningBrief_opportunity_id_fkey" FOREIGN KEY ("opportunity_id") REFERENCES "Opportunity"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "OutreachRecord" ADD CONSTRAINT "OutreachRecord_contact_id_fkey" FOREIGN KEY ("contact_id") REFERENCES "Contact"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OutreachRecord" ADD CONSTRAINT "OutreachRecord_opportunity_id_fkey" FOREIGN KEY ("opportunity_id") REFERENCES "Opportunity"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CompBenchmark" ADD CONSTRAINT "CompBenchmark_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;
